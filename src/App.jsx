                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                      <input
                        ...
                        className="text-yellow-500 focus:ring-yellow-500"
                      />
                      <span className="text-sm text-gray-700">Até R$ 50</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                      <input
                        type="radio"
                        ...
                        className="text-yellow-500 focus:ring-yellow-500"
                      />
                      <span className="text-sm text-gray-700">R$ 50 - R$ 100</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                      <input
                        type="radio"
                    ...
                    <label className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                      <input
                        ...
                        className="text-yellow-500 focus:ring-yellow-500"
                      />
                      <span className="text-sm text-gray-700">Acima de R$ 200</span>
                    </label>
                  </div>
                </div>
              </aside>
